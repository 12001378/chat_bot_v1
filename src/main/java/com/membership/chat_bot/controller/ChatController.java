package com.membership.chat_bot.controller;

import com.membership.chat_bot.payload.ChatRequest;
import com.membership.chat_bot.payload.ChatResponse;
import com.membership.chat_bot.payload.TraningDTO;
import com.membership.chat_bot.service.DeepSeekService;
import com.membership.chat_bot.service.TrainedQAService;
import com.membership.chat_bot.service.TrainedService;
...
//
        ...
        for (TraningDTO question : trainedQAService.trainQAList()) {
            requests.add(new ChatRequest(question.getQuestion()));
        }
